...
/******/ 			var chunk = require("./" + ({"1":"pages/fun","2":"pages/index","3":"pages/more-fun/index"}[chunkId]||chunkId) + ".js");
...
module.exports.__inject__ = function (context) {
  add("580db8f4", content, true, context)
};
...
var add = __webpack_require__(8).default
module.exports.__inject__ = function (context) {
  add("7fc2315c", content, true, context)
};
...
const _3c5c8f76 = () => interopDefault(__webpack_require__.e(/* import() | pages/fun */ 1).then(__webpack_require__.bind(null, 46)));

const _30141c3c = () => interopDefault(__webpack_require__.e(/* import() | pages/more-fun/index */ 3).then(__webpack_require__.bind(null, 47)));

const _6c17e4ee = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 48))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./dist/components/nuxt-error.vue?vue&type=template&id=efa6d18c&
...
external_vue_default.a.filter('formatted', function (date = new Date()) {
  if (!date) return '';
...
external_vue_default.a.filter('lun_dom_day', function (date = new Date()) {
  return date.getDay() == 0 ? date.getDay() - 1 : 6;
});
external_vue_default.a.filter('scale', function (v = new Number(), min = new Number(), max = new Number()) {
  return (v - min) / (max - min);
});
external_vue_default.a.filter('min', function (values = new Array()) {
  return Math.min(...values);
});
external_vue_default.a.filter('max', function (values = new Array()) {
  return Math.max(...values);
});
external_vue_default.a.filter('DateTimeFormat', function (v = new Date()) {
